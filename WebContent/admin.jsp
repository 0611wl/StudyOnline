    ...
    <div class="col-sm-* col-md-*">
        ...
        <div class="panel panel-default">
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
              	<c:forEach items="${waitForCheckStudents }" var="student">
              		<tr>
              			<td>暂无</td>
              			<td>${student.studentId }</td>
              			<td>${student.name }</td>
              			...
              			<td>${student.telphone }</td>
              			<td>${student.email }</td>
              			<td><a href="deleteStudent.action">通过</td>
              			<td><a href="deleteStudent.action">不通过</td>
              		</tr>
              	</c:forEach>
              </tbody>
            </table>
